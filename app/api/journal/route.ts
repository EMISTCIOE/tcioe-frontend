...
export async function GET(request: NextRequest) {
  try {
    ...
    const allowed = ["department_slug", "genre", "ordering", "search"];
    ...
    const backendUrl = `${API_BASE_URL}/api/v1/public/journal-mod/articles?${query.toString()}`;
    ...
    return handleApiError(error, "list", "journal");
  }
}
